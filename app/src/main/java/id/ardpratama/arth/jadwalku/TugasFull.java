 ...
 */
public class TugasFull extends ListActivity {
    private ProgressDialog pDialog;

    // URL to get contacts JSON
    private static String url = "http://ardpratama.web.id/asro/jadwalku/gettgs.php";
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(TugasFull.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case android.R.id.home:
                Intent i = new Intent(TugasFull.this, MainActivity.class);
                startActivity(i);
                finish();
                return true;
        }
